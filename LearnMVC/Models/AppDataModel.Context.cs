...
namespace LearnMVC.Models
{
    ...
    public partial class AppDataConnectionEntity : DbContext
    {
        ...
        public virtual ObjectResult<Download_AllUserList_Result> Download_AllUserList(string userID)
        {
            var userIDParameter = userID != null ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Download_AllUserList_Result>("Download_AllUserList", userIDParameter);
        }
    
        public virtual ObjectResult<Search_User_List_Result> Search_User_List(string searchBy, string search)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Search_User_List_Result>("Search_User_List", searchByParameter, searchParameter);
        }
    
        public virtual ObjectResult<Get_Upload_TransactionLog_Result> Get_Upload_TransactionLog(string userid, Nullable<System.DateTime> from, Nullable<System.DateTime> to, string uploadfiletype)
        {
            var useridParameter = userid != null ?
                new ObjectParameter("userid", userid) :
                new ObjectParameter("userid", typeof(string));
            ...
            var uploadfiletypeParameter = uploadfiletype != null ?
                new ObjectParameter("uploadfiletype", uploadfiletype) :
                new ObjectParameter("uploadfiletype", typeof(string));
